...
import type { UrlListItem, UrlRequest, UrlResponse, UrlStatsResponse } from "../types";
...
export const urlService = {
    ...
    getAllUrlsForAdmin: async(): Promise<UrlListItem[]> => {
        const response = await api.get<UrlListItem[]>('/urls/admin/list');
        return response.data;
    },
};